...
var mako = class {
  static async addmakoticket(url, ua) {
    const json = await import_axios.default.get("https://mass.mako.co.il/ClicksStatistics/entitlementsServicesV2.jsp?et=ngt&lp=/i/24live_1@195271/master.m3u8?b=200-2500&rv=AKAMAI", { headers: { "user-agent": ua } });
